...
def render_page_content(pathname):
    if pathname == "/":
        return html.Div([
            ...
            html.Img(src='https://github.com/Sanae-Juanmi-DASH/Dash-app/blob/main/houseprices.jpg?raw=true'),
            html.Br(),
            html.Br(),
            html.H4("Context"),
            ...
            **- prefer:** Factor. Is the house located in the preferred neighborhood of the city?
            ...
            html.Img(src='https://github.com/Sanae-Juanmi-DASH/Dash-app/blob/main/diabetes.jpg?raw=true'),
            html.Br(),
            html.Br(),
            html.H4("Context"),
